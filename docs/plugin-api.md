...
| `branch_transforms` | array | no | Ordered replacements for title-derived worktree branches. Requires `api_version >= 14`. See [Branch transforms](#branch-transforms). |
